...
def path_to_url(path):#输入电脑路径
    root_path="static/"
    url="http://192.168.1.106:8080/download/"
    path=path.strip("/")
                    ...
                    if os.path.isfile(path):#是文件
                        ...
                        if "." in path:
                            ...
                            if checkp=="jpe" or checkp=="jpeg" or checkp=="jpg" or checkp=="gif" or checkp=="png" or checkp=="tif" or checkp=="tiff" :
                                ...
                                htm=htm.replace("[file]",'<td style="text-align:center;"><h2>%s</h2></td><td width="100px"><a href="%s"><img src="http://192.168.1.106:8080/icons/download.jpg" alt="downlaod" width="100" height="100"></a></td></tr>[file]'%(file_list[i],real_url))
                            else:#非图片
                                htm=htm.replace("[file]",'<tr style="background-color:#FFFFCC"><td style="height:200px;width:260px"><img src="http://192.168.1.106:8080/icons/erro.jpg" alt="%s" width="250" height="150"/></td>[file]'%(file_list[i]))
                                htm=htm.replace("[file]",'<td style="text-align:center;"><h2>%s</h2></td><td width="100px"><a href="%s"><img src="http://192.168.1.106:8080/icons/download.jpg" alt="downlaod" width="100" height="100"></a></td></tr>[file]'%(file_list[i],real_url))
                        else:#无扩展名
                            htm=htm.replace("[file]",'<tr style="background-color:#FFFFCC"><td style="height:200px;width:260px"><img src="http://192.168.1.106:8080/icons/erro.jpg" alt="%s" width="250" height="150"/></td>[file]'%(file_list[i]))
                            htm=htm.replace("[file]",'<td style="text-align:center;"><h2>%s</h2></td><td width="100px"><a href="%s"><img src="http://192.168.1.106:8080/icons/download.jpg" alt="downlaod" width="100" height="100"></a></td></tr>[file]'%(file_list[i],real_url))
                    else:#是文件夹
                        htm=htm.replace("[path]",'<tr style="background-color:#FFFFCC"><td style="height:200px;width:260px"><img src="http://192.168.1.106:8080/icons/dir.jpg" alt="%s" width="250" height="150"/></td>[path]'%(file_list[i]))
                        htm=htm.replace("[path]",'<td style="text-align:center;"><h2>%s</h2></td><td width="100px"><a href="%s"><img src="http://192.168.1.106:8080/icons/open.jpg" alt="open" width="100" height="100"></a></td></tr>[path]'%(file_list[i],real_url))
                htm=htm.replace("[link]",'<tr><td><img src="http://192.168.1.106:8080/icons/upload.jpg" alt="upload" width="200" height="150"/></td><td colspan="2"><a href="http://192.168.1.106:8080/upload/%s"><h2>在此上传</h2></a></td></tr>[link]'%name)
                htm=htm.replace("[link]",'<tr><td><img src="http://192.168.1.106:8080/icons/new.jpg" alt="new" width="200" height="150"/></td><td colspan="2"><a href="http://192.168.1.106:8080/new/%s"><h2>新建文件夹</h2></a></td></tr>'%name)
